...
### 2050
gmt grdimage $dirname/msl_rcp26_2050.nc?total_slr[0] -Q -J$J -Rg -Y10.7c -X0.3c -K -Bwesn+t"RCP2.6 AIS: 0 cm" -nn -Cmidcpt.cpt > $ps
gmt pscoast -R -J -Dc -A5000/0/1+ai -G170/170/170  -K -O >> $ps
echo "3 -78 a 23 cm" | gmt pstext -R -J -F+f8,Helvetica-Bold+jLM -O -K >> $ps

gmt grdimage $dirname/msl_rcp85_2050.nc?total_slr[0] -Q -J$J -Rg -X$xjump -O -K -Bwesn+t"RCP8.5 AIS: 0cm" -nn -Cmidcpt.cpt >> $ps
gmt pscoast -R -J -Dc -A5000/0/1+ai -G170/170/170  -K -O >> $ps
echo "3 -78 b 28 cm" | gmt pstext -R -J -F+f8,Helvetica-Bold+jLM -O -K >> $ps

gmt grdimage $dirname/msl_rcp26_2050.nc?total_slr[2] -Q -J$J -Rg -Y$yjump -X-$xjump -O -K -Bwesn+t'RCP2.6 AIS: 10 cm' -nn -Cmidcpt.cpt >> $ps
gmt pscoast -R -J -Dc -A5000/0/1+ai -G170/170/170  -K -O >> $ps
...
gmt grdimage $dirname/msl_rcp85_2050.nc?total_slr[2] -Q -J$J -Rg -X$xjump -O -K -Bwesn+t'RCP8.5 AIS: 10 cm'  -nn -Cmidcpt.cpt >> $ps
gmt pscoast -R -J -Dc -A5000/0/1+ai -G170/170/170  -K -O >> $ps
echo "3 -78 d 38 cm" | gmt pstext -R -J -F+f8,Helvetica-Bold+jLM -O -K >> $ps

### 2100

gmt grdimage $dirname/msl_rcp26_2100.nc?total_slr[0] -Q -J$J -Rg -Y$yjump2 -X-$xjump -O -K -Bwesn+t'RCP2.6 AIS: 0 cm'  -nn -Cendcpt.cpt >> $ps
gmt pscoast -R -J -Dc -A5000/0/1+ai -G170/170/170  -K -O >> $ps
echo "3 -78 e 36 cm" | gmt pstext -R -J -F+f8,Helvetica-Bold+jLM -O -K >> $ps

gmt grdimage $dirname/msl_rcp85_2100.nc?total_slr[0] -Q -J$J -Rg -X$xjump -O -K -Bwesn+t'RCP8.5 AIS: 0 cm'  -nn -Cendcpt.cpt >> $ps
gmt pscoast -R -J -Dc -A5000/0/1+ai -G170/170/170  -K -O >> $ps
echo "3 -78 f 60 cm" | gmt pstext -R -J -F+f8,Helvetica-Bold+jLM -O -K >> $ps

gmt grdimage $dirname/msl_rcp26_2100.nc?total_slr[3] -Q -J$J -Rg -Y$yjump -X-$xjump -O -K -Bwesn+t'RCP2.6 AIS: 15 cm'  -nn -Cendcpt.cpt >> $ps
gmt pscoast -R -J -Dc -A5000/0/1+ai -G170/170/170  -K -O >> $ps
...
gmt grdimage $dirname/msl_rcp85_2100.nc?total_slr[5] -Q -J$J -Rg -X$xjump -O -K -Bwesn+t'RCP8.5 AIS: 30 cm'  -nn -Cendcpt.cpt >> $ps
gmt pscoast -R -J -Dc -A5000/0/1+ai -G170/170/170  -K -O >> $ps
echo "3 -78 h 90 cm" | gmt pstext -R -J -F+f8,Helvetica-Bold+jLM -O -K >> $ps

gmt grdimage $dirname/msl_rcp26_2100.nc?total_slr[5] -Q -J$J -Rg -Y$yjump -X-$xjump -O -K -Bwesn+t'RCP2.6 AIS: 30 cm'  -nn -Cendcpt.cpt >> $ps
gmt pscoast -R -J -Dc -A5000/0/1+ai -G170/170/170  -K -O >> $ps
echo "3 -78 i 66 cm" | gmt pstext -R -J -F+f8,Helvetica-Bold+jLM -O -K >> $ps

gmt grdimage $dirname/msl_rcp85_2100.nc?total_slr[7] -Q -J$J -Rg -X$xjump -O -K -Bwesn+t'RCP8.5 AIS: 60 cm'  -nn -Cendcpt.cpt >> $ps
gmt pscoast -R -J -Dc -A5000/0/1+ai -G170/170/170  -K -O >> $ps
