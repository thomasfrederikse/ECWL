...
gmt set PS_MEDIA=Custom_15.5cx18.4c
...
gmt psxy af_RCP26_2050_0.txt -R -J -O -K -Sc$circrad  -t35 -Camp_cpt.cpt >> $ps
gmt psbasemap -J$J2 -R0/1/0/125 -X6c -O -K -Byg25 -Bxg0.5 -BwesN  >> $ps
gmt psxy  -R -J -SB$barwidth -N -G$color1  -O -K hist_all_RCP26_2050_0.txt >> $ps
...
gmt pscoast -R -J -Dc -A5000/0/1+ai -G170/170/170 -S#c6dbef -K -O >> $ps
gmt psxy af_RCP85_2050_0.txt -R -J -O -K -Sc$circrad -t35  -Camp_cpt.cpt >> $ps
gmt psbasemap -J$J2 -R0/1/0/125 -X6c -O -K -Bychistannots.txt -Bxg0.5 -BwEsN  >> $ps
gmt psxy  -R -J -SB$barwidth -N -G$color1  -O -K hist_all_RCP85_2050_0.txt >> $ps
...
gmt pscoast -R -J -Dc -A5000/0/1+ai -G170/170/170 -S#c6dbef -K -O >> $ps
gmt psxy af_RCP26_2050_0.1.txt -R -J -O -K -Sc$circrad -t35  -Camp_cpt.cpt  >> $ps
gmt psbasemap -J$J2 -R0/1/0/125 -X6c -O -K -Byg25 -Bxg0.5 -Bwesn  >> $ps
gmt psxy  -R -J -SB$barwidth -N -G$color1  -O -K hist_all_RCP26_2050_0.1.txt >> $ps
...
gmt pscoast -R -J -Dc -A5000/0/1+ai -G170/170/170 -S#c6dbef -K -O >> $ps
gmt psxy af_RCP85_2050_0.1.txt -R -J -O -K -Sc$circrad -t35  -Camp_cpt.cpt  >> $ps
gmt psbasemap -J$J2 -R0/1/0/125 -X6c -O -K -Bychistannots.txt -Bxg0.5 -BwEsn  >> $ps
gmt psxy  -R -J -SB$barwidth -N -G$color1  -O -K hist_all_RCP85_2050_0.1.txt >> $ps
gmt psxy  -R -J -SB$barwidth -N -G$color2  -O -K hist_ntr_RCP85_2050_0.1.txt >> $ps
gmt psxy  -R -J -SB$barwidth -N -G$color3  -O -K hist_tr_RCP85_2050_0.1.txt >> $ps

### 2100

gmt psbasemap -J$J1 -Rg -Y$yjump2  -X$xback -O -K -Bwesn+t"RCP2.6 AIS: 0 cm"  >> $ps
gmt pscoast -R -J -Dc -A5000/0/1+ai -G170/170/170 -S#c6dbef -K -O >> $ps
gmt psxy af_RCP26_2100_0.txt -R -J -O -K -Sc$circrad  -t35 -Camp_cpt.cpt  >> $ps
gmt psbasemap -J$J2 -R0/1/0/125 -X6c -O -K -Byg25 -Bxg0.5 -Bwesn  >> $ps
...
gmt psbasemap -J$J1 -Rg -X$xjump -O -K -Bwesn+t"RCP8.5 AIS: 0 cm"  >> $ps
gmt pscoast -R -J -Dc -A5000/0/1+ai -G170/170/170 -S#c6dbef -K -O >> $ps
gmt psxy af_RCP85_2100_0.txt -R -J -O -K -Sc$circrad -t35  -Camp_cpt.cpt  >> $ps
gmt psbasemap -J$J2 -R0/1/0/125 -X6c -O -K -Bychistannots.txt -Bxg0.5 -BwEsn  >> $ps
...
gmt pscoast -R -J -Dc -A5000/0/1+ai -G170/170/170 -S#c6dbef -K -O >> $ps
gmt psxy af_RCP26_2100_0.15.txt -R -J -O -K -Sc$circrad  -t35 -Camp_cpt.cpt  >> $ps
gmt psbasemap -J$J2 -R0/1/0/125 -X6c -O -K -Byg25 -Bxg0.5 -Bwesn  >> $ps
...
gmt pscoast -R -J -Dc -A5000/0/1+ai -G170/170/170 -S#c6dbef -K -O >> $ps
gmt psxy af_RCP85_2100_0.3.txt -R -J -O -K -Sc$circrad -t35  -Camp_cpt.cpt  >> $ps
gmt psbasemap -J$J2 -R0/1/0/125 -X6c -O -K -Bychistannots.txt -Bxg0.5 -BwEsn  >> $ps
...
gmt pscoast -R -J -Dc -A5000/0/1+ai -G170/170/170 -S#c6dbef -K -O >> $ps
gmt psxy af_RCP26_2100_0.3.txt -R -J -O -K -Sc$circrad -t35  -Camp_cpt.cpt  >> $ps
gmt psscale  -Dx0c/-0.45c+w9.5c/0.3c+ef+h-R -J -Np -Camp_cpt.cpt  -B10  -O -By -Bx+l'AF@-100@-' -S -K >> $ps
gmt psbasemap -J$J2 -R0/1/0/125 -X6c -O -K -Byg25 -Bxg0.5 -Bwesn  >> $ps
...
gmt pscoast -R -J -Dc -A5000/0/1+ai -G170/170/170 -S#c6dbef -K -O >> $ps
gmt psxy af_RCP85_2100_0.6.txt -R -J -O -K -Sc$circrad -t35  -Camp_cpt.cpt  >> $ps
gmt psbasemap -J$J2 -R0/1/0/125 -X6c -O -K -Bychistannots.txt -Bxg0.5 -BwEsn  >> $ps
